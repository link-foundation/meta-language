...
- Detect code across the complete pull request so a documentation-only final commit cannot suppress Rust validation, while keeping genuinely empty pushes empty.

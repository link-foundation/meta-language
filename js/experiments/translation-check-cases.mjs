...
// all four source languages. Each case is written to <outdir>/<name>/ with its
// surface AST and checked IR (or error) dumped by translation-stage-dump.mjs,
// so the Rust checker can be compared with the JavaScript one case by case.
// Usage: node experiments/translation-check-cases.mjs <outdir>
